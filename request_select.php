        ...
        <a href="request_create.php?type=Budget" 
           class="glass-tile block p-8">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-2xl font-bold">Budget Request</h3>
                <p class="text-sm mt-2">For requesting funds and general activity budgets.</p>
            </div>
        </a>
        ...
        <a href="request_create.php?type=Liquidation" 
           class="glass-tile block p-8">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-2xl font-bold">Liquidation Form</h3>
                <p class="text-sm mt-2">For reporting the use of previously approved funds.</p>
            </div>
        </a>
        ...
        <a href="request_create.php?type=Reimbursement" 
           class="glass-tile block p-8">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-2xl font-bold">Reimbursement</h3>
                <p class="text-sm mt-2">For recovering personal funds used for organization expenses.</p>
            </div>
        </a>
        ...
        <a href="request_venue.php" 
           class="glass-tile block p-8">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-2xl font-bold">Venue Booking</h3>
                <p class="text-sm mt-2">For reserving rooms, halls, or facilities.</p>
            </div>
        </a>
