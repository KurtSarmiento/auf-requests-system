...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif (isset($_FILES["supporting_file"]) && $_FILES["supporting_file"]["error"] !== 4) {
        // Handle other upload errors (e.g., ini size, partial upload)
        $file_err = "A file was selected but an error occurred during upload (Code: " . $_FILES["supporting_file"]["error"] . ").";
        $file_upload_success = false;
    } else {
        // No file was uploaded (Error code 4) - This is generally acceptable for initial drafts
